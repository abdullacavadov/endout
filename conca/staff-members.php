            ...
            <div class="app-content-wrapper py-20 pb-13">
                <div class="container ">
                    <div class="page-header pb-7 d-flex justify-content-between align-items-center gap-6 flex-wrap">
                        <div class="">
                            <h2 class="fw-semibold fs-7">Heyət</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Ana Səhifə</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Heyət</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="">
                            <a href="staff-member-add.php" class="btn btn-primary d-flex align-items-center gap-2">
                                    ...
                                    <div class="pure-card-body">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th scope="col" class="text-custom-paragraph fw-medium">User
                                                        </th>
                                                        <th scope="col" class="text-custom-paragraph fw-medium">Email
                                                        </th>
                                                        <th scope="col" class="text-custom-paragraph fw-medium">Role
                                                        </th>
                                                        <th scope="col" class="text-custom-paragraph fw-medium">Status
                                                        </th>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <img class="rounded-pill"
                                                                        src="assets/img/avatar/<?= $row['photo'] ?>"
                                                                        width="40" height="40" alt="Conca User">
                                                                    <div class="ms-3">
                                                                        <p class="mb-0 h6"><?= $row['full_name']; ?></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <span class="text-custom-body"><?= $row['email']; ?></span>
                                                            </td>
                                                            <td>
                                                                <span class="text-primary"><?= $row['role']; ?></span>
                                                            </td>
                                                            <td>
                                                                <span
                                                                    class="badge badge-label-success"><?= $row['status'] ?></span>
                                                            </td>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <a href="staff-member-edit.php?mid=<?= $row['id']; ?>"
                                                                    ...
                                                                    <a href="api/delete/staff_members.php?mid=<?= $row['id']; ?>"
