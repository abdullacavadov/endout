            ...
            <div class="app-content-wrapper py-20 pb-13">
                <div class="container ">
                    <div class="page-header pb-7 d-flex justify-content-between align-items-center gap-6 flex-wrap">
                        <div class="">
                            <h2 class="fw-semibold fs-7">İcazələr</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Ana Səhifə</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">İcazələr</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="">
                            <a href="staff-permissions-add.php" class="btn btn-primary d-flex align-items-center gap-2">
                                    ...
                                    <div class="pure-card-body">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th scope="col" class="text-custom-paragraph fw-medium">#</th>
                                                        <th scope="col" class="text-custom-paragraph fw-medium">İcazə Adı
                                                        </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($result as $row) {
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span
                                                                    class="text-custom-paragraph fw-medium"><?= $i; ?>.</span>
                                                            </td>
                                                            <td>
                                                                <span
                                                                    class="text-custom-body"><?= $row['permission'] . ' (' . $row['name'] . ')'; ?></span>
                                                            </td>
                                                            <td>
                                                                <?php if ($row['permission_is_active'] == 'Aktiv') { ?>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <a href="staff-permissions-edit.php?pid=<?= $row['id']; ?>"
                                                                    ...
                                                                    <a href="api/delete/staff_permissions.php?pid=<?= $row['id']; ?>"
