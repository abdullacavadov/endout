        ...
        <div id="app-wrapper" class="app-wrapper d-flex flex-column align-items-stretch min-vh-100">
            ...
            <div class="app-content-wrapper py-20 pb-13">
                <div class="container ">
                    ...
                    <form id="package_edit" method="post">


                        <div class="page-header pb-7 d-flex justify-content-between align-items-center gap-6 flex-wrap">
                            <div class="">
                                <h2 class="fw-semibold fs-7">Paket məlumatlarını redaktə et</h2>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="packages.php">Paketlər</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Paket məlumatlarını
                                            redaktə et</li>
                                    </ol>
                                            ...
                                            <div class="row gy-5 mb-5">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" id="base_price" name="base_price"
                                                        ...
                                                        value="<?= htmlspecialchars($package['base_price']) ?>"
                                                        required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row gy-5 mb-5">
                                                <div class="col-md-12">
                                                    ...
                                                    <select class="form-control" id="is_active" name="is_active"
                                                        required>
                                                        <option value="1" <?php if ($package['is_active'] == 1)
                                                            echo 'selected'; ?>>Aktiv</option>
                                                        <option value="0" <?php if ($package['is_active'] == 0)
