...
<body>
            ...
            <div class="app-content-wrapper py-20 pb-13">
                <div class="container ">
                    <div class="page-header pb-7 d-flex justify-content-between align-items-center gap-6 flex-wrap">
                        <div class="">
                            <h2 class="fw-semibold fs-7">Abunəlik paketləri üçün xüusiyyətlər</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Ana Səhifə</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Abunəlik paketləri üçün
                                        xüusiyyətlər</li>
                                </ol>
                            </nav>
                        </div>
                                ...
                                <div class="pure-card rounded-custom card-bg shadow-custom">
                                    <div class="pure-card-header">
                                        <h3 class="pure-card-title d-flex align-items-center gap-2 m-0">
                                            ...
                                            Abunəlik paketləri üçün xüusiyyətlər
                                        </h3>
                                    </div>
                                                ...
                                                <div class="card shadow-sm">
                                                    <div class="card-header">
                                                        <h5 class="mb-0">
                                                            ...
                                                            Yeni parametr əlavə et
                                                        </h5>
                                                    </div>

                                                    <div class="card-body">

                                                        <form id="add_features">

                                                            <div class="row gy-2 mb-5">
                                                                <div class="col-md-12">
                                                                    <label for="feature_key" class="form-label">Feature
                                                                        key</label>
                                                                    <input class="form-control" id="feature_key"
                                                                        name="feature_key" placeholder="Məs: max_posts">
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <label for="description"
                                                                        class="form-label">Açıqlama</label>
                                                                    <textarea class="form-control" id="description"
                                                                        name="description" rows="3"
                                                                        placeholder="Məs: Paket üzrə maksimum post paylaşma limiti"></textarea>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <label for="category"
                                                                        class="form-label">Kateqoriya</label>
                                                                    <select class="form-control" id="category"
                                                                        name="category"
                                                                        placeholder="Məs: Maksimum post">
                                                                        <option value="limit">Limit</option>
                                                                        <option value="enabled">İmkan</option>
                                                                    </select>
                                                                </div>
                                            ...
                                            <div class="col-lg-8">
                                                <div class="alert alert-primary">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <span class="text-custom-body">Parametrləri sürükləyərək
                                                            sıralaya
                                                            bilərsiniz.</span>
                                                    </div>
                                                </div>
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody id="sortable-features">
                                                            ...
                                                            SELECT id, feature_key, title, description, value_type, category, sort_order, is_active
                                                        ...
                                                        ");
                                                            ...
                                                            foreach ($result as $row) {
                                                                ...
                                                                <tr data-id="<?= $row['id']; ?>">
                                                                    ...
                                                                    <td>
                                                                        <span class="text-custom-body fw-bolder">
                                                                            <?= $row['sort_order']; ?>
                                                                        </span>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <span class="text-custom-body">
                                                                            ...
                                                                            if($row['value_type'] == 'int'){
                                                                                echo 'Tam ədəd (int)';
                                                                            } elseif ($row['value_type'] == 'decimal') {
                                                                                echo 'Onluq ədəd (decimal)';
                                                                            } elseif ($row['value_type'] == 'sting') {
                                                                                echo 'Mətn';
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <a href="feature-edit.php?fid=<?= $row['id']; ?>"
                                                                                ...
                                                                                <svg width="17" height="16"
                                                                                    ...
                                                                                    <path
                                                                                        ...
                                                                                        stroke-linejoin="round" />
                                                                                    <path
                                                                                        d="M9.19922 2.39996L14.0992 7.29996"
                                                                                        stroke="currentColor"
                                                                                        stroke-width="1.5"
                                                                                        stroke-linejoin="round" />
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const form = document.getElementById("add_features");
            ...
            form.addEventListener("submit", function (e) {
                ...
                fetch("./api/create/feature_definitions.php", {
                    method: "POST",
                    body: formData
                })
                    ...
                    .then(response => {
                        ...
                        if (response.trim() === "success") {
                            ...
                            Swal.fire({
                                title: "Paket xüsusiyyət uğurla əlavə edildi.",
                                html: "Bu xüsusiyyəti paketlərə əlavə etmək üçün <a href='package-features.php'>Paket parametrləri</a> səhifəsinə keçin.",
                                icon: "success",
                                draggable: true
                            });
                            form.reset();
    ...
    <script>
        new Sortable(document.getElementById('sortable-features'), {
            animation: 150,
            handle: ".drag-handle",
            ...
            onEnd: function () {
                ...
                fetch("api/update/features_sort_order.php", {
                    method: "POST",
                    headers: {
                    ...
                    .then(res => {
                        ...
                        if (res.status) {
                            ...
                            document.querySelectorAll("#sortable-features tr").forEach((row, index) => {
                                row.querySelector("td:nth-child(2)").innerHTML = index + 1;
                            });
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            deleteButtons.forEach(button => {
                ...
                button.addEventListener("click", function (e) {
                    ...
                    Swal.fire({
                        title: packageName,
                        text: "Bu xüsusiyyət silinəcək və geri qaytarılmayacaq!",
                        icon: "warning",
