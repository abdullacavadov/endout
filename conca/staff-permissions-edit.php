...
$stmt = $pdo->prepare("SELECT * FROM tbl_permissions WHERE id = ?");
$stmt->execute([$pid]);
                                        ...
                                        <div class="pure-card-body mt-5">
                                            <div class="row gy-5 mb-5">
                                                <div class="col-md-12">
                                                    ...
                                                    <input class="form-control" id="permissions_name" name="name"
                                            ...
                                            <div class="row gy-5 mb-5">
                                                <div class="col-md-12"></div>
                                                    ...
                                                    <input class="form-control" id="permissions" name="permission"
                                                        ...
                                                        value="<?= htmlspecialchars($permission['permission']) ?>">
                                                </div>
                                            </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            form.addEventListener("submit", function (e) {
                ...
                fetch("./api/update/staff_permissions.php", {
                    method: "POST",
                    body: formData
                })
