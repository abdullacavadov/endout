<?php require_once("inc/config.php"); require_once("inc/admin_auth.php"); require_admin_permission($pdo, "countries"); ?>
            ...
            <div class="app-content-wrapper py-20 pb-13">
                <div class="container ">
                    <div class="page-header pb-7 d-flex justify-content-between align-items-center gap-6 flex-wrap">
                        <div class="">
                            <h2 class="fw-semibold fs-7">Ölkələr</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Ana Səhifə</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Ölkələr</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="">
                            <a href="country-add.php" class="btn btn-primary d-flex align-items-center gap-2">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="d-flex align-items-center gap-2">
                                                                    <img id="country_flag"
                                                                        src="https://www.worldometers.info/images/flags/original/<?= strtolower($row['iso2']); ?>.webp"
                                                                        alt="<?= $row['name']; ?>" width="32" height="20"
                                                                        class="object-fit-cover">


                                                                    <span
                                                                        class="text-custom-body"><?= $row['name'] . ' (' . $row['iso2'] . ')'; ?></span>
                                                                </span>
                                                            </td>
                                                            
                                                            <td>
                                                                <span class="text-custom-body"><?= $row['area']; ?></span>
                                                            </td>
                                                            <td>
                                                                <?= $row['city_count']; ?>
                                                            </td>
                                                            <td>
                                                                <span
                                                                    class="text-custom-body"><?= $row['country_audience']; ?></span>
                                                            </td>
                                                            <td>
                                                                <span class="text-custom-body">x
                                                                    <?= $row['coefficient']; ?></span>
                                                            </td>
                                                            <td>
                                                                <span
                                                                    class="text-custom-body"><?= $row['currency_name'] . ' (' . $row['currency_symbol'] . ')'; ?></span>
                                                            </td>
                                                            <td>
                                                                <?php if ($row['country_status'] == 'active') { ?>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <a href="country-edit.php?cid=<?= $row['id']; ?>"
                                                                    ...
                                                                    <a href="api/delete/country.php?cid=<?= $row['id']; ?>"
                                                                        class="btn btn-sm btn-icon btn-icon-secondary rounded-pill delete-btn"
                                                                        type="button" data-bs-toggle="tooltip"
                                                                        data-bs-placement="top"
                                                                        data-bs-original-title="Sil"
                                                                        data-country-name="<?= $row['name']; ?>"
                                                                        data-flag="https://www.worldometers.info/images/flags/original/<?= strtolower($row['iso2']); ?>.webp">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            deleteButtons.forEach(button => {
                ...
                button.addEventListener("click", function (e) {
                    ...
                    Swal.fire({
                        title: "<img src=" + src + " height='100'><br>" + countryName,
