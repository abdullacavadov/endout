...
foreach ($result_user as $row_user) {
    $user_fullname = $row_user['full_name'];
    $user_photo = $row_user['photo'];
            ...
            <ul class="navbar-nav flex-row align-items-center justify-content-end">
                ...
                <!-- <li class="header-nav-item me-2">
                    <a class="header-nav-link" href="javascript:void(0);" data-bs-toggle="dropdown"
                        data-bs-auto-close="outside" style="position: relative;">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-xl py-0">
                        <div
                            class="dropdown-header d-flex align-items-center justify-content-between border-bottom py-4">
                            <h6 class="mb-0">Notifications</h6>
                            <button type="button"
                                class="text-muted clear-all-notifications-btn d-flex align-items-center gap-2">
                                Clear All
                            </button>
                        </div>
                        <div class="dropdown-body">
                            <div class="dropdown-list notification-list-scroll">
                                <div
                                    class="dropdown-item notification-list-item d-flex align-items-center m-0 w-100 rounded-none">
                                    <div class="me-3 flex-shrink-0">
                                        <div class="avatar avatar-md avatar-online">
                                            <img src="assets/img/avatar/15.html" alt="" class="rounded-circle">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-start">
                                        <p class="mb-0 text-custom-secondary">New user registered</p>
                                    ...
                                    <div class="ms-auto">
                                        <button type="button" class="text-muted notification-remove-btn">
                                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                                                ...
                                                <path d="M10.75 0.75L0.75 10.75M0.75 0.75L10.75 10.75"
                                ...
                                <div
                                    ...
                                    <div class="flex-grow-1 text-start">
                                        <p class="mb-0 text-custom-secondary">A new order has been placed
                                        </p>
                                        ...
                                        <div class="avatar avatar-md avatar-online">
                                            <div class="avatar-text bg-label-primary rounded-pill">
                                                <svg width="23" height="22" viewBox="0 0 23 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M7.57501 13.35H14.925M7.57501 8.09998H11.25"
                                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path
                                                        d="M13.5291 20.0601C17.9213 19.7681 21.4199 16.2199 21.7077 11.7654C21.7641 10.8937 21.7641 9.99097 21.7077 9.11926C21.4199 4.66479 17.9213 1.11659 13.5291 0.824628C12.0307 0.725022 10.4662 0.725226 8.97087 0.824628C4.57871 1.11659 1.08013 4.66479 0.792252 9.11926C0.735916 9.99097 0.735916 10.8937 0.792252 11.7654C0.8971 13.3878 1.6146 14.8899 2.4593 16.1583C2.94976 17.0463 2.62608 18.1546 2.11522 19.1227C1.74688 19.8207 1.56271 20.1697 1.71058 20.4219C1.85846 20.674 2.18877 20.682 2.8494 20.6981C4.15585 20.7299 5.03682 20.3595 5.73611 19.8439C6.13272 19.5514 6.33103 19.4052 6.46771 19.3884C6.60438 19.3715 6.87336 19.4823 7.41121 19.7038C7.89462 19.9029 8.45591 20.0258 8.97087 20.0601C10.4662 20.1595 12.0307 20.1597 13.5291 20.0601Z"
                                ...
                                <div
                                    ...
                                    <div class="me-3 flex-shrink-0">
                                        <div class="avatar avatar-md avatar-online">
                                            <img src="assets/img/avatar/01.html" alt="" class="rounded-circle">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-start">
                                        <p class="mb-0 text-custom-secondary">User has verified email</p>
                ...
                <li class="header-nav-item header-style-switcher me-2">
                    <a class="header-nav-link" href="javascript:void(0);" data-bs-toggle="dropdown">
                        ...
                        <i class="fa-solid fa-circle-half-stroke" style="font-size: 23px;"></i>
                    </a>
                            ...
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0);"
                                ...
                                <span>
                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M7.25 0.75V1.75M7.25 12.75V13.75M13.75 7.25H12.75M1.75 7.25H0.75M11.85 2.65L11.14 3.36M3.36 11.14L2.65 11.85M11.85 11.85L11.14 11.14M3.36 3.36L2.65 2.65M10.5 7.25C10.5 9.04493 9.04493 10.5 7.25 10.5C5.45507 10.5 4 9.04493 4 7.25C4 5.45507 5.45507 4 7.25 4C9.04493 4 10.5 5.45507 10.5 7.25Z"
                                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </span>
                            ...
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0);"
                                ...
                                <span>
                                    <svg width="15" height="13" viewBox="0 0 15 13" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M6.25 9.75L5.25 12.25M8.25 9.75L9.25 12.25M4.25 12.25H10.25M1.25 0.75H13.25C13.5261 0.75 13.75 0.973858 13.75 1.25V9.25C13.75 9.52614 13.5261 9.75 13.25 9.75H1.25C0.973858 9.75 0.75 9.52614 0.75 9.25V1.25C0.75 0.973858 0.973858 0.75 1.25 0.75Z"
                                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </span>
                ...
                <!-- User Options -->
                <li class="header-nav-item header-user me-2 ms-2">
                    <a class="header-nav-link" href="javascript:void(0);" data-bs-toggle="dropdown">
                        <img src="assets/img/avatar/<?php echo $user_photo; ?>" alt="" width="34" height="34"
                        ...
                        <div class="dropdown-header d-flex align-items-center border-bottom py-4">
                            <div class="me-3 flex-shrink-0">
                                <div class="avatar avatar-md">
                                    <img src="assets/img/avatar/<?php echo $user_photo; ?>" height="50" width="50" style="object-fit: cover;" alt=""
                                        class="rounded-circle">
                                </div>
                            </div>
                            <div class="flex-grow-1 text-start">
                                <h6 class="mb-0"><?php echo $user_fullname; ?></h6>
