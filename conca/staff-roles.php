            ...
            <div class="app-content-wrapper py-20 pb-13">
                <div class="container ">
                    <div class="page-header pb-7 d-flex justify-content-between align-items-center gap-6 flex-wrap">
                        <div class="">
                            <h2 class="fw-semibold fs-7">Vəzifələr</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Ana Səhifə</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Vəzifələr</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="">
                            <a href="staff-roles-add.php" class="btn btn-primary d-flex align-items-center gap-2">
                                    ...
                                    <div class="pure-card-body">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th scope="col" class="text-custom-paragraph fw-medium">Vəzifə
                                                        </th>
                                                        <th scope="col" class="text-custom-paragraph fw-medium">İcazələr
                                                        </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $statement = $pdo->prepare("SELECT * FROM tbl_roles ORDER BY role_id DESC");
                                                    $statement->execute();
                                                    ...
                                                    foreach ($result as $row) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="text-custom-body"><?= $row['role_permissions']; ?></span>
                                                            </td>
                                                            <td>
                                                                <?php if ($row['role_is_active'] == 'Aktiv') { ?>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <a class="btn btn-sm btn-icon btn-icon-secondary rounded-pill"
                                                                        href="staff-roles-edit.php?rid=<?= $row['role_id']; ?>"
                                                                    ...
                                                                    <a href="./api/delete/staff_roles.php?rid=<?= $row['role_id'] ?>"
